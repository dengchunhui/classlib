		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				var settings = $.extend({
					...
					swf: '/scripts/uploadify/uploadify.swf',  // The path to the uploadify SWF file
					uploader: '/ashx/upload.ashx',  // The path to the server-side upload script
					...
					buttonText      : '请选择',     // The text to use for the browse button
					...
					fileTypeDesc: '.jpg .gif .bmp .png',        // The description for file types in the browse dialog
					fileTypeExts: '*.jpg;*.jpeg;*.gif;*.bmp;*.png',              // Allowed extensions in the browse dialog (server-side validation should also be used)
